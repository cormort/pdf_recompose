// ==========================================================
// === 變更 #1：在最開頭加入 import (使用本地檔案和 CDN 模組) ===
// ==========================================================
...
// ==========================================================
// === 修正：更換為 unpkg 這個 CDN 的 fontkit 網址 ===
// ==========================================================
import fontkit from 'https://unpkg.com/@pdf-lib/fontkit@1.1.1/dist/fontkit.esm.js';
